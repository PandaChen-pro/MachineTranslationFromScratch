...
def parse_args():
    ...
    parser.add_argument('--wandb_project', type=str, default='nmt-noam-label-smoothing-transformer', help='wandb项目名')
    parser.add_argument('--wandb_name', type=str, default='zh-en-noam-label-smoothing-transformer', help='wandb运行名')
